...
Autogenerate support for SQLAlchemy models.
"""
...
sqlalchemy_url = os.getenv(
    "DATABASE_URL",
    "postgresql://postgres:postgres@localhost:5432/nexusai"
)

# For async driver, convert to sync URL for migration script
if "asyncpg" in sqlalchemy_url:
    sqlalchemy_url = sqlalchemy_url.replace("postgresql+asyncpg://", "postgresql://")
elif "aiosqlite" in sqlalchemy_url:
    # SQLite: convert aiosqlite to sqlite
